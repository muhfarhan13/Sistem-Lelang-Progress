...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 12:28 PM
...
INSERT INTO `tb_barang` (`id_barang`, `nama_barang`, `gambar_barang`, `tgl`, `harga_awal`, `deskripsi_barang`) VALUES
(1, 'Mobil', 'https://imgcdn.oto.com/medium/gallery/color/14/1995/honda-brio-color-968735.jpg', '2021-05-11', 50000000, 'Honda brio no minus');
...
(1, 1, '2021-05-20', 70000000, 1, 1, 'dibuka');
...
(1, 'Bejo Surajo', 'bejo', 'bejo', '0832713812');
